...
<head>
    ...
    <link href="<?= base_url() ?>/assets/assets-vendor/bootstrap/css/sb-admin-2.css" rel="stylesheet">
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 ml-3 text-gray-800 d-flex align-items-center justify-content-center" style="font-weight: bold;"><?php echo $tittle; ?></h1>
                ...
                <?php echo $this->renderSection('contentDashboardUser'); ?>
    ...
    <script src="<?= base_url() ?>/assets/custom-js/sb-admin-2.min.js"></script>
